<div class="container body-student">
	<div class="row">
		...
		<div class="col-sm-9" style="border-left: 2px solid #ccc">
			...
			<div class="row">
				<form name="new-search" id="new-search" method="POST" action ="<?php echo base_url()?>new-job"  enctype="multipart/form-data">
					<div class="col-sm-12">
						<h2 style="display: inline-block;">
							<?php echo lang('Q_NEW_LIST'); ?>
							
								<?php echo lang('MONTH_'.date("m"));?>
							
							<co class="recordsTotal"></co>
