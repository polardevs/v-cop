<div class="container body-company">
	<div class="row">
		...
		<div class="col-sm-10">
			<div class="row">
				<div class="col-sm-12">
					<h2><?php echo lang('COMPANY_MENU_FIND');?></h2>
					<hr>
				</div>
				<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-12" id="result-student">
					<h3><?php echo lang('SEARCH_RESULT') ?> <span class="p1"></span> <?php echo lang('LIST') ?></h3>
				</div>
				<div class="col-sm-12" id="result-not-found">
					<h3><?php echo lang('FIND_NONE') ?></h3>
				</div>
			</div>
...
<script>
	$(document).ready(function() {
		...
		schoolId ='<?php echo $this->input->post("schoolId") ?>';
		...
		if('<?php echo($this->input->post("post")) ;?>'){
			...
			$("select[name='schoolId']").select2('val','<?php echo $this->input->post("schoolId")?>');
			
			$('#schoolId').select2({"val": "<?php echo $this->input->post("schoolId")?>"});
