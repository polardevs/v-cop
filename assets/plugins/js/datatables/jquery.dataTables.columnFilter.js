...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" class="' + search_init + sCSSClass + ' input-sm" placeholder="' + inputvalue + '..." rel="' + i + '"/>');
        ...
        function fnCreateRangeInput(oTable) {
           ...
           // th.html(_fnRangeLabelPart(0));
            ...
            var from = $('<div class="col-xs-6"><input type="text" class="number_range_filter form-control input-sm" placeholder="'+_fnRangeLabelPart(0)+'..." id="' + sFromId + '" rel="' + i + '"/></di>');
            th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<div class="col-xs-6"><input type="text" class="number_range_filter form-control  input-sm" placeholder="'+_fnRangeLabelPart(1)+'..." id="' + sToId + '" rel="' + i + '"/></div>');
            th.append(to);
            //th.append(_fnRangeLabelPart(2));
           // th.wrapInner('<span class="filter_column filter_number_range form-control" />');
            th.wrapInner('<div class="row" />');
            var index = i;
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="date_range_filter form-control input-sm" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="date_range_filter form-control input-sm" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            var r = '<select class="search_init select_filter form-control input-sm select2" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
			if(bMultiselect) {
				r = '<select class="search_init select_filter form-control input-sm select2" rel="' + i + '" multiple>';
			}
            var j = 0;
